...
public class Matrix4D {
	...
	public static Matrix4D initPerspective(float fov, float aspectRatio, float zNear, float zFar) {
		...
		Matrix4D out = new Matrix4D(new Point4D(1.0f / (tan * aspectRatio), 0, 0, 0), new Point4D(0, 1.0f / tan, 0, 0),
				new Point4D(0, 0, (-zNear - zFar) / zRange, 1), new Point4D(0, 0, 2 * zFar * zNear / zRange, 0));
